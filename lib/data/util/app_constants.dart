import '../model/response/lang_model.dart';

class AppConstants {
  static const String appName = 'StackFood';
  static const double appVersion = 6.3;

  static const String baseUrl = 'https://dull-teal-fossa-boot.cyclic.app';
  static const String postListUri = "/posts";
  ...
  static const String paymentUri = '/api/v1/order';
  ...
  /// Languages
  static List<LanguageTransModel> languages = [
    LanguageTransModel(
        image: "",
